...
use PAGE\DemoBundle\Form\AgentType;
...
class AgentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PAGEDemoBundle:Agent')->findAll();
     ...
     * @Method("POST")
     * @Template("PAGEDemoBundle:Agent:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PAGEDemoBundle:Agent')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PAGEDemoBundle:Agent:edit.html.twig")
     */
