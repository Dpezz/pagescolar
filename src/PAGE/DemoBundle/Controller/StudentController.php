...
use PAGE\DemoBundle\Entity\Student;
use PAGE\DemoBundle\Entity\InStudent;
use PAGE\DemoBundle\Entity\InStudentIn;
use PAGE\DemoBundle\Entity\Agent;
use PAGE\DemoBundle\Form\StudentType;
...
class StudentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PAGEDemoBundle:Student')->findAll();
     ...
     * @Method("POST")
     * @Template("PAGEDemoBundle:Student:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            #create In Student
            $in_entity = new InStudent();
            $in_entity -> setStudent($entity);
            #create in student in
            $in_entity_in = new InStudentIn();
            $in_entity_in -> setStudent($entity);
            #create agent
            $agent = new Agent();
            $agent -> setStudent($entity);
            $em = $this->getDoctrine()->getManager();
            $em->persist($entity);
            $em->persist($in_entity);
            $em->persist($in_entity_in);
            $em->flush();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PAGEDemoBundle:Student')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PAGEDemoBundle:Student:edit.html.twig")
     */
