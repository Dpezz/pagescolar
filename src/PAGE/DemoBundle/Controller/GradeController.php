...
use PAGE\DemoBundle\Entity\Grade;
use PAGE\DemoBundle\Form\GradeType;
...
class GradeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PAGEDemoBundle:Grade')->findAll();
     ...
     * @Method("POST")
     * @Template("PAGEDemoBundle:Grade:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PAGEDemoBundle:Grade')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PAGEDemoBundle:Grade:edit.html.twig")
     */
