...
use PAGE\DemoBundle\Entity\Subject;
use PAGE\DemoBundle\Form\SubjectType;

/**
 * Subject controller.
 *
 * @Route("/profile/subject")
 */
class SubjectController extends Controller
{
     ...
     * @Method("POST")
     * @Template("PAGEDemoBundle:Subject:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PAGEDemoBundle:Subject')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PAGEDemoBundle:Subject:edit.html.twig")
     */
