...
use PAGE\DemoBundle\Entity\Document;
use PAGE\DemoBundle\Form\DocumentType;
...
class DocumentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PAGEDemoBundle:Document')->findAll();
     ...
     * @Method("POST")
     * @Template("PAGEDemoBundle:Document:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PAGEDemoBundle:Document')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PAGEDemoBundle:Document:edit.html.twig")
     */
